...
import de.getsetsociety.gw2readr.item.items.entities.Armor;
import de.getsetsociety.gw2readr.item.items.entities.AttributeModifier;
import de.getsetsociety.gw2readr.item.items.entities.BackItem;
import de.getsetsociety.gw2readr.item.items.entities.Bag;
import de.getsetsociety.gw2readr.item.items.entities.Buff;
import de.getsetsociety.gw2readr.item.items.entities.Consumable;
import de.getsetsociety.gw2readr.item.items.entities.Container;
import de.getsetsociety.gw2readr.item.items.entities.CraftingMaterial;
import de.getsetsociety.gw2readr.item.items.entities.Gathering;
import de.getsetsociety.gw2readr.item.items.entities.Gizmo;
import de.getsetsociety.gw2readr.item.items.entities.InfixUpgrade;
import de.getsetsociety.gw2readr.item.items.entities.InfusionSlot;
import de.getsetsociety.gw2readr.item.items.entities.MiniPet;
import de.getsetsociety.gw2readr.item.items.entities.Tool;
import de.getsetsociety.gw2readr.item.items.entities.Trinket;
import de.getsetsociety.gw2readr.item.items.entities.Trophy;
import de.getsetsociety.gw2readr.item.items.entities.UpgradeComponent;
import de.getsetsociety.gw2readr.item.items.entities.Weapon;
