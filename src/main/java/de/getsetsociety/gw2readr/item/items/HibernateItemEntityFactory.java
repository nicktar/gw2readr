...
import de.getsetsociety.gw2readr.item.items.hibernateentities.Armor;
import de.getsetsociety.gw2readr.item.items.hibernateentities.AttributeModifier;
import de.getsetsociety.gw2readr.item.items.hibernateentities.BackItem;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Bag;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Buff;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Consumable;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Container;
import de.getsetsociety.gw2readr.item.items.hibernateentities.CraftingMaterial;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Gathering;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Gizmo;
import de.getsetsociety.gw2readr.item.items.hibernateentities.InfixUpgrade;
import de.getsetsociety.gw2readr.item.items.hibernateentities.InfusionSlot;
import de.getsetsociety.gw2readr.item.items.hibernateentities.MiniPet;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Tool;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Trinket;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Trophy;
import de.getsetsociety.gw2readr.item.items.hibernateentities.UpgradeComponent;
import de.getsetsociety.gw2readr.item.items.hibernateentities.Weapon;
...
public class HibernateItemEntityFactory implements IItemEntityFactory {
	...
	/* (non-Javadoc)
	 * @see de.getsetsociety.gw2readr.IEntityFactory#newInfusionSlot()
	 */
	@Override
