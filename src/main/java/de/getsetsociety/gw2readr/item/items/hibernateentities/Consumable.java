...
import de.getsetsociety.gw2readr.item.items.enums.ConsumableType;
import de.getsetsociety.gw2readr.item.items.enums.ConsumableUnlockType;
import de.getsetsociety.gw2readr.item.items.interfaces.IConsumable;

@Entity
@Table
@PrimaryKeyJoinColumn(name="ConsumableId")
