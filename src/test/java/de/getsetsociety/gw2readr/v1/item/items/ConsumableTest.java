...
public class ConsumableTest {
    ...
    public void testConsumableUnlock067224() {
        ...
        try {
            ...
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] {ItemFlags.AccountBindOnUse, ItemFlags.NoSalvage, ItemFlags.NoSell, ItemFlags.NoMysticForge, ItemFlags.AccountBound})));
    ...
    public void testConsumableTransmutation043030() {
        ...
        try {
            ...
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] {ItemFlags.AccountBindOnUse, ItemFlags.NoSalvage, ItemFlags.NoSell, ItemFlags.AccountBound})));
            assertTrue(item.getRestrictions().isEmpty());
            assertNull(item.getDurationMs());
    ...
    public void testConsumableGeneric020328() {
        ...
        try {
            ...
            assertEquals(4,  item.getFlags().size());
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] {ItemFlags.AccountBindOnUse, ItemFlags.NoUnderwater, ItemFlags.NoSell, ItemFlags.AccountBound})));
            assertTrue(item.getRestrictions().isEmpty());
            assertNull(item.getDurationMs());
            assertNull(item.getRecipeId());
            assertNull(item.getColorId());
    ...
    public void testConsumableAppearanceChange036285() {
        ...
        try {
            ...
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] {ItemFlags.SoulbindOnAcquire, ItemFlags.AccountBindOnUse, ItemFlags.NoSalvage, ItemFlags.NoSell, ItemFlags.NoMysticForge, ItemFlags.AccountBound})));
            assertTrue(item.getRestrictions().isEmpty());
            assertNull(item.getDurationMs());
            assertNull(item.getRecipeId());
            assertNull(item.getColorId());
    ...
    public void testConsumableUpgradeRemoval020349() {
        ...
        try {
            ...
            assertEquals(Rarity.Fine, item.getRarity());
            assertEquals(4,  item.getFlags().size());
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] {ItemFlags.AccountBindOnUse, ItemFlags.NoSell, ItemFlags.NoMysticForge, ItemFlags.AccountBound})));
            assertTrue(item.getRestrictions().isEmpty());
            assertNull(item.getDurationMs());
            assertNull(item.getRecipeId());
            assertNull(item.getColorId());
