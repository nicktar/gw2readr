...
public class WeaponTest {
    ...
    public void testWeaponGreatsword053029() {
        ...
        try {
	        ...
	        assertThat(item.getFlags(), hasItems(ItemFlags.HIDE_SUFFIX, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
	        assertThat(item.getDamageType(), is(DamageType.PHYSICAL));
    ...
    public void testWeaponNotUpgradeableTwoHandedToy043092() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.RARE));
	        assertThat(item.getFlags().size(), is(5));
	        assertThat(item.getFlags(), hasItems(ItemFlags.NOT_UPGRADEABLE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
	        assertThat(item.getDamageType(), is(DamageType.PHYSICAL));
    ...
    public void testWeaponLargeBundle049935() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.RARE));
	        assertThat(item.getFlags().size(), is(5));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.NOT_UPGRADEABLE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE, ItemFlags.NO_MYSTIC_FORGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
	        assertThat(item.getDamageType(), is(DamageType.PHYSICAL));
