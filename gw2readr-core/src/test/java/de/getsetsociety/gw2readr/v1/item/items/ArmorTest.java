...
public class ArmorTest {
    ...
    public void testArmorMediumHelmSoulBindOnUseNoSellAccountBoundInfixUpgradeNoSlotNoRestriction018431() throws IOException {
	    ...
	    assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND));
    ...
    public void testArmorLightBoots066512() {
        ...
        try {
	        ...
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.ACCOUNT_BOUND));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorHideSuffix002404() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.EXOTIC));
	        assertThat(item.getFlags().size(), is(2));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.HIDE_SUFFIX));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorLeggingsNoSalvage005252() {
        ...
        try {
	        ...
	        assertThat(item.getFlags(), hasItems(ItemFlags.NO_SALVAGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
	        assertThat(item.getDefense(), is(97));
	        assertThat(item.getInfixUpgrade().getAttributes().size(), is(3));
    ...
    public void testArmorHeavy001752() {
        ...
        try {
	        ...
	        assertThat(item.getFlags().size(), is(1));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorShouldersAccountBindOnUseDefenseSlot048005() {
        ...
        try {
	        ...
	        assertThat(item.getFlags(), hasItems(ItemFlags.HIDE_SUFFIX, ItemFlags.NO_SALVAGE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.ACCOUNT_BOUND));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorCoatSoulbindOnAcquire064561() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.RARE));
	        assertThat(item.getFlags().size(), is(4));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.NO_SALVAGE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorNoMysticForge043625() {
        ...
        try {
	        ...
	        assertThat(item.getFlags(), hasItems(ItemFlags.NO_SALVAGE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorNornRestriction063448() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.MASTERWORK));
	        assertThat(item.getFlags().size(), is(2));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.SOUL_BIND_ON_ACQUIRE));
    ...
    public void testArmorAsuraRestriction006071() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.EXOTIC));
	        assertThat(item.getFlags().size(), is(3));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE));
	        assertThat(item.getRestrictions().size(), is(1));
    ...
    public void testArmorClothing039531() {
        ...
        try {
	        ...
	        assertThat(item.getFlags().size(), is(4));
	        assertThat(item.getFlags(), hasItems(ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorHelmAquatic004943() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.FINE));
	        assertThat(item.getFlags().size(), is(5));
	        assertThat(item.getFlags(), hasItems(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.HIDE_SUFFIX, ItemFlags.NO_SALVAGE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testArmorNotUpgradeable001321() {
        ...
        try {
	        ...
	        assertThat(item.getRarity(), is(Rarity.BASIC));
	        assertThat(item.getFlags().size(), is(1));
	        assertThat(item.getFlags(), hasItems(ItemFlags.NOT_UPGRADEABLE));
	        assertThat(item.getRestrictions().isEmpty(), is(true));
    ...
    public void testVipersExaltedMasque() throws IOException {
	    ...
	    assertThat(item.getAvailableInWvW(), is(true));
	    assertThat(item.getFlags().size(), is(2));
	    assertThat(item.getFlags(), hasItems(ItemFlags.ACCOUNT_BOUND, ItemFlags.SOUL_BIND_ON_USE));
