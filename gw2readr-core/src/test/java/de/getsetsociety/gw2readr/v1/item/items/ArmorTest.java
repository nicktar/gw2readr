...
public class ArmorTest {
    ...
    @Test
    public void testArmorMediumHelmAccountBoundSoulBindOnUseNoSellInfixUpgradeNoSlotNoRestriction018431() {
        ...
        try {
            ...
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] { ItemFlags.AccountBound, ItemFlags.SoulBindOnUse, ItemFlags.NoSell })));
