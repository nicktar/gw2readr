...
public class ContainerTest {
    ...
    public void testContainerDefaultAccountBindOnUseNoSellAccountBoundNoRestriction061738() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND)));
    ...
    public void testContainerNoSalvageNoMysticForge044387() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NO_SALVAGE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
    ...
    public void testContainerGiftBox012748() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NO_SELL)));
	        assertTrue(item.getRestrictions().isEmpty());
    ...
    public void testContainerSoulbindOnAcquire064348() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NO_SALVAGE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
    ...
    public void testContainerSoulBindOnUse043961() {
        ...
        try {
	        ...
	        assertEquals(Rarity.FINE, item.getRarity());
	        assertEquals(5, item.getFlags().size());
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.NO_SALVAGE, ItemFlags.NO_SELL, ItemFlags.SOUL_BIND_ON_ACQUIRE, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
    ...
    public void testContainerNotUpgradeable067406() {
        ...
        try {
	        ...
	        assertEquals(Rarity.MASTERWORK, item.getRarity());
	        assertEquals(5, item.getFlags().size());
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NOT_UPGRADEABLE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
    ...
    public void testContainerNoUnderwater066895() {
        ...
        try {
	        ...
	        assertEquals(Rarity.MASTERWORK, item.getRarity());
	        assertEquals(3, item.getFlags().size());
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NO_SELL, ItemFlags.NO_UNDERWATER, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
    ...
    public void testContainerHideSuffix036366() {
        ...
        try {
	        ...
	        assertEquals(5, item.getFlags().size());
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.HIDE_SUFFIX, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND, ItemFlags.NO_MYSTIC_FORGE)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(ContainerType.Default, item.getContainerType());
        } catch (Exception e) {
           e.printStackTrace();
