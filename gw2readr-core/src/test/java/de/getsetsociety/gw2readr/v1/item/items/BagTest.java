...
public class BagTest {
    ...
    public void testBagNoSalvageAccountBindOnUseNoSellAccountBound008941() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.NO_SALVAGE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.NO_SELL, ItemFlags.ACCOUNT_BOUND)));
	        assertTrue(item.getRestrictions().isEmpty());
    ...
    public void testBagSoulBindOnUseSoulbindOnAcquire036040() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.SOUL_BIND_ON_USE, ItemFlags.SOUL_BIND_ON_ACQUIRE)));
	        assertTrue(item.getRestrictions().isEmpty());
    ...
    public void testBagUnique038010() {
        ...
        try {
	        ...
	        assertTrue(item.getFlags().containsAll(Arrays.asList(ItemFlags.UNIQUE, ItemFlags.ACCOUNT_BIND_ON_USE, ItemFlags.ACCOUNT_BOUND)));
	        assertTrue(item.getRestrictions().isEmpty());
	        assertEquals(Integer.valueOf(20), item.getSize());
        } catch (Exception e) {
           e.printStackTrace();
