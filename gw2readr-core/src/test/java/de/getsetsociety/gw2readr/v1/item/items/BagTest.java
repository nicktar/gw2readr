...
public class BagTest {
    ...
    @Test
    public void testBagAccountBoundAccountBindOnUseNoSalvageNoSell008941() {
    ...
    @Test
    public void testBagSoulbindOnAcquireSoulBindOnUse036040() {
    ...
    public void testBagUnique038010() {
        ...
        try {
            ...
            assertTrue(item.getFlags().containsAll(Arrays.asList(new ItemFlags[] { ItemFlags.AccountBound, ItemFlags.Unique, ItemFlags.AccountBindOnUse })));
            assertTrue(item.getRestrictions().isEmpty());
            assertEquals(Integer.valueOf(20), item.getSize());
        } catch (Exception e) {
            e.printStackTrace();
